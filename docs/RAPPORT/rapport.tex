...
EF5 & Transport d’objets légers sur palette motorisée & H & Capacité de charge jusqu’à 1 kg. \\ \hline
...
\begin{itemize}
    \item \textbf{Contraintes physiques}: masse totale du robot inférieure à 2~kg.
...
\textbf{Capacité de charge:} transport sécurisé d’objets légers (jusqu’à 1 kg dans la version actuelle).
