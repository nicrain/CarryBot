...
Masse totale & \textit{À renseigner (mesure réelle)} \\ \hline
Dimensions (L $\times$ l $\times$ h) & \textit{À renseigner} \\ \hline
Charge utile & $\approx$ 2 kg (objectif) \\ \hline
...
Vitesse moyenne & \textit{8 $\approx$ 10 (cm/s)} \\ \hline
