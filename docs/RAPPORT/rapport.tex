...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../images/CB-global.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../images/monter.png}
        \caption{La montée de la palette motorisée}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../images/descente.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.55\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../images/prototype.jpg}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../images/add.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../images/connect.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../images/language.png}
        \caption{Sélection de langue}
    \end{minipage}
    \hfill
    \begin{minipage}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../images/contrast.png}
