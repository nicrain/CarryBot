...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{../img/architecture-Glob.png}
...
\begin{figure}[H]
    ...
    séparation client, supervision Raspberry Pi et exécution MegaPi}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.55\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../img/prototype.jpg}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../img/add.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../img/connect.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../img/language.png}
        \caption{Sélection de langue}
    \end{minipage}
    \hfill
    \begin{minipage}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{..//img/contrast.png}
