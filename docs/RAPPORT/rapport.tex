...
% =============================================================
\subsubsection*{5. Synthèse architecturale}
% =============================================================

L’organisation hiérarchique peut être résumée ainsi :

\begin{center}
Application $\rightarrow$ Raspberry Pi $\rightarrow$ MegaPi $\rightarrow$ Actionneurs
\end{center}

Cette séparation fonctionnelle améliore :

\begin{itemize}
    \item la maintenabilité,
    \item la robustesse temporelle du contrôle moteur,
    \item la clarté des responsabilités,
    \item la possibilité d’évolution future (navigation autonome, SLAM).
\end{itemize}
...
% =============================================================
% CONCLUSION GÉNÉRALE (à ajouter en fin, avant Bibliographie)
% =============================================================
\section{Conclusion générale}

Le projet CarryBot a permis de développer un démonstrateur fonctionnel intégrant une architecture
mécatronique complète (mécanique, électronique embarquée, supervision logicielle et interface mobile).
Les objectifs majeurs — transport d’objets légers, pilotage manuel accessible et sécurisation via arrêts
d’urgence — ont été implémentés dans une version prototype.

Les essais internes confirment la capacité de franchissement de petites marches (environ 4~cm) et le
principe de stabilisation active du plateau via vérin et capteurs inertiels. Néanmoins, le niveau de
maturité actuel met en évidence plusieurs verrous: re-dimensionnement de la motorisation, robustesse
d’intégration (câblage/tenue mécanique), formalisation des modes dégradés et augmentation de la
reproductibilité des tests.

Les perspectives prioritaires portent sur: (1) le re-dimensionnement du couple moteur et de la chaîne
d’alimentation, (2) la standardisation du protocole de validation (mesures, logs, taux de réussite),
et (3) l’intégration du mode semi-autonome initialement envisagé (suivi de bande au sol) avec une
stratégie de sécurité associée.

CarryBot constitue ainsi une base solide et exploitable pédagogiquement, tout en proposant une
orientation claire vers une montée en maturité technique et ergonomique pour un usage réel en
