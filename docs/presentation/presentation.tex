...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.30\linewidth]{../images/img1.png} &
\includegraphics[width=0.30\linewidth]{../images/img2.png} \\

{\footnotesize Vue globale} &
{\footnotesize Tri-Star} \\[0.3cm]

\includegraphics[width=0.30\linewidth]{../images/img3.png} &
\includegraphics[width=0.30\linewidth]{../images/img4.png} \\
...
\centering
\includegraphics[width=0.95\linewidth]{../images/logique.png}\\[0.2cm]
...
\column{0.5\textwidth}
\centering
\includegraphics[width=3.2cm]{../images/Home.jpg}\\
...
\column{0.55\textwidth}
\centering
\includegraphics[width=3.2cm]{../images/Add.jpg}\\
...
\column{0.55\textwidth}
\centering
\includegraphics[width=3.2cm]{../images/connect.jpg}\\
...
\column{0.35\textwidth}
\centering
\includegraphics[width=2.2cm]{../images/connect-phone.png}\\
...
\centering
\includegraphics[width=0.95\linewidth]{../images/ArchitectureFoncGlob.png}\\[0.2cm]
{\scriptsize Logique de connexion entre Raspberry Pi, MegaPi, caméra, moteurs, vérin et capteurs}
\end{frame}
%--------------------------------------------------------------
...
\only<1>{
\centering
\includegraphics[width=\linewidth]{../images/axeFixe.jpg}\\
