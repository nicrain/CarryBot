...
\begin{itemize}
    \item Ajout d’un second moteur arrière
    \item UPS Shield + 4 batteries 18650 (5A stable)
    \item Pilotage vérin via pont en H L293D
    \item Structure modulaire Makeblock
    \item Roues Tri-Star imprimées en 3D
\end{itemize}
