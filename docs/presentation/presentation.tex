...
\begin{itemize}
    \item Intégration du suivi de ligne.
    \item Optimisation mécanique.
    \item Re-dimensionnement de la motorisation.
    \item Amélioration de l'application 
    \item Version plus grande \textbf{capacité}.
