...
{\scriptsize Sélection et gestion des robots enregistrés}
...
\begin{itemize}
    ...
    \item Validation rapide de la connexion.
...
{\scriptsize Mode contraste élevé}
...
\begin{itemize}
    \item Possibilité d'activé la vidéo 
\end{itemize}
\end{frame}
...
%--------------------------------------------------------------
% Bibliography handled manually below to avoid BibTeX warnings.
% The automatic \bibliography{references} was removed.
% A manual thebibliography environment is provided later in the file.
\begin{frame}[allowframebreaks]{Bibliographie}
\footnotesize
\begin{thebibliography}{9}
\bibitem{bloss2011} Bloss, A. (2011). Titre de l'article ou rapport. Source institutionnelle.
\bibitem{bourdon2023} Bourdon, B. (2023). Titre de l'article. Nom de la revue ou site.
\end{thebibliography}
\end{frame}
% -------------------------------------------------------------
\begin{frame}
